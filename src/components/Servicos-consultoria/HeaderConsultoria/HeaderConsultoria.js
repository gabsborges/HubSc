import './HeaderConsultoria.css'
import { Link } from "react-router-dom";

function HeaderConsultoria() {
    return (
<div className='header header-consultoria'>
            ...
            <nav>
                <ul className="menu menu-preto">
                    ...
                    <li><span className="ativo">SERVIÇOS<i className="fa-solid fa-chevron-down"></i></span>
                        <ul>
