import './FooterConsultoria.css'
import { Link } from "react-router-dom";

function FooterConsultoria() {
    return (
        <div className='footerConsultoria'>
        <div className='footer-menu'>
            ...
            <nav>
                    <ul className="menu-footer">
                        ...
                        <li><span className="hover ativo">SERVIÇOS<i className="fa-solid fa-chevron-down"></i></span>
...
export default FooterConsultoria